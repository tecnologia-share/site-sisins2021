      ...
      <Container>
          ...
          <Row>
            ...
            <Column>
              ...
              <Subtexto1>
                ...
                <br />
                <br />A Share é uma Entidade Estudantil fundada em 2016 por
                alunos de Ciências Econômicas na UFSCar - Campus Sorocaba, com o
                intuito de conectar o desejo de ensinar com a vontade de
                aprender. Para isso oferecemos semestralmente cursos de idioma,
          ...
          <Row>
            ...
            <Column>
              ...
              <Subtexto3>
                ...
                <br />
                No primeiro semestre de 2020 mais de 3.900 pessoas tanto no
                Brasil quanto no exterior se inscreveram em cursos na Share
                <br />
                Oferecemos 18 cursos e ofertamos 370 vagas
                <br />
                Fomos destaque no G1 Notícias, Site da UFSCar Sorocaba, Rádio
                Jornal Cruzeiro do Sul e TV Sorocaba(SBT)
              </Subtexto3>
            </Column>
          </Row>
        </Artigo3>
        <Artigo4>
          <Row>
            <Column>
              <Texto4>
                &apos;Conectar o desejo de ensinar com a vontade de
                aprender&apos;
              </Texto4>
              <Subtexto4>
                &apos;Fazer o curso de oratória na share, para mim, foi
                incrível! Além de ter a oportunidade de conhecer pessoas de
                outros cursos e pessoas de fora da UFSCar, as aulas me
                proporcionaram um aprendizado muito rico sobre técnicas de
                apresentação, como se portar durante um discurso e como ser
                claro e coerente ao passar uma mensagem verbal. Indico a Share
                para todos aqueles que tem vontade de aprender de uma forma
                inovadora!&apos;
                <br />
                <br />
                ...
                minha professora (tanto que agora ela é minha aluna de alemão),
                Já sabia muito do idioma, mas eu não tinha nenhuma prova ou
                certificado e isso me ajudou muito: quase fui contratada como
                professora de espanhol esse ano, mas por não atender meu horário
                de disponibilidade mesmo que eu não consegui&apos;
                <br />
                <br />
                <b>
