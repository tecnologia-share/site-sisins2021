...
describe('Create Selection Process tests', () => {
  ...
  it('Deve ser possível editar um curso.', async () => {
  ...
  it('Deve ser possível editar um curso somente se este curso existir.', async () => {
    const response = await request(app)
      .patch('/api/courses')
      .set({ 'x-access-token': adminToken })
      .send({
  ...
  it('Somente o admin pode editar um curso.', async () => {
    const response = await request(app)
      .patch('/api/courses')
