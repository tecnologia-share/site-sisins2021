...
| GET    | [/api/subscriptions/:id](./subscriptions/showSubscribe.md)                                   | Lista os inscritos no curso.                                     |
| PATCH    | [/api/subscriptions](./subscriptions/evaluate.md)                                   | Avaliar uma inscrição.                                     |
